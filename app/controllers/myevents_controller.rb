class MyeventsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @myevent.save
        format.html { redirect_to myevent_url(@myevent), notice: "Myevent was successfully created." }
  ...
  def update
    respond_to do |format|
      if @myevent.update(myevent_params)
        format.html { redirect_to myevent_url(@myevent), notice: "Myevent was successfully updated." }
  ...
  private
    ...
    def myevent_params
      params.require(:myevent).permit(:name, :event_date)
    end
end
